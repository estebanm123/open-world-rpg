...
protected:
    ...
    isEntityBlockingPath(OrganismOwner *receivingEntity, NpcAi<OrganismOwner> *ai, CollidingEntity *otherEntity) {
        ...
        auto safeDistPastOther = distToOther + maxOtherLength + maxReceivingLength; // ray length; doesn't need to be precise as long as it reaches past the other entity
        ...
        auto edgePoint1 = receivingPos + sf::Vector2f{receivingMoveDir.y, -receivingMoveDir.x} * maxReceivingLength / 2.f;
        auto edgeEndPoint1 = edgePoint1 + translation;
        auto edgePoint2 = receivingPos + sf::Vector2f{-receivingMoveDir.y, receivingMoveDir.x} * maxReceivingLength / 2.f;
