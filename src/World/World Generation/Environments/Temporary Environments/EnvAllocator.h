...
struct EnvAllocator {
	...
	typedef std::array<std::array<std::shared_ptr<NeighboredEnv>, TileMap::SIZE_Y + 2>, TileMap::SIZE_X + 2>
		TmpNeighboredEnvs;
	typedef std::array<std::array<std::shared_ptr<NeighboredEnv>, TileMap::SIZE_Y>, TileMap::SIZE_X>
		FinalNeighboredEnvs;
	...
	static std::shared_ptr<NeighboredEnv> getEnvFromNeighbors(const std::shared_ptr<EnvWrapper> &initialEnv,
