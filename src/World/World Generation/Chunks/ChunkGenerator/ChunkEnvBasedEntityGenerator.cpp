...
bool ChunkEnvBasedEntityGenerator::isEntityValid(Entity *entity, const TileMap &tiles, TilesSeen &tilesSeen,
...
ChunkEnvBasedEntityGenerator::ChunkEnvBasedEntityGenerator(const int entityGenLimitMax, const int entityGenLimitChange,
                                                           const int entityGenLimitInitial) : entityGenLimitMax(
        entityGenLimitMax), entityGenLimitChange(entityGenLimitChange), entityGenLimitInitial(entityGenLimitInitial) {}
