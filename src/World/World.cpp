...
void World::renderBy(sf::RenderTarget &renderer) { chunkManager.renderChunks(renderer); }

void World::handleInput(sf::RenderWindow &window) { player->handleInput(window); }
...
int World::generateSeed() { return GlobalRand::rand.getIntInRange(0, INT16_MAX); }