...
bool AnimationPlayer::hasCurrentAnim() const { return curAnim != nullptr; }
...
bool AnimationPlayer::noAnimCurrentlyPlaying() { return curAnim == nullptr || curAnim->peekNextFrame() == EMPTY_FRAME; }
